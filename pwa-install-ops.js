// pwa-install-ops.js — Install banner for Xantex OPS admin app
(function () {
  const INSTALLED_KEY = 'xantex_ops_pwa_installed';
  ...
  const STYLE = `
    ...
    #xpwa-install:hover { background: #b91c1c; }
    #xpwa-dismiss {
  ...
  window.addEventListener('beforeinstallprompt', e => {
    ...
    setTimeout(() => {
      ...
      banner.innerHTML = `
        <div id="xpwa-icon"><img src="/images/admin-icon-192.png" alt="Xantex OPS"></div>
        <div id="xpwa-text">
          <strong>Xantex OPS</strong>
      ...
      sheet.innerHTML = `
        ...
        <div class="xpwa-step">
          ...
          <div class="xpwa-step-icon">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#dc2626" stroke-width="2.5"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><polyline points="16 6 12 2 8 6"/><line x1="12" y1="2" x2="12" y2="15"/></svg>
          </div>
        </div>
        <div class="xpwa-step">
